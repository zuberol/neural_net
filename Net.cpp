...
Net::~Net() {
    ...
    void Net::Feed_forward(vector<double> &inputs){
        ...
        //initialize net Inputs with training data inputs
    ...
    void Net::Back_propagation(vector<double> &targets) {
        ...
        // 1. Calculate overall net cost
        cost = calculate_cost(targets);

        // 2.1. Calculate output_layer delta for each neuron (node)
        ...
        // 2.2. Calculate hidden_layers delta for each neuron (node)
